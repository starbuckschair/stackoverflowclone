        ...
        <>
            ...
            <ContentBox>
               ...
               <Body>
                ...
                <BodyMain>
                    <BodyMainTitle>
                    This bounty has ended. Answers to this question are eligible for a +50 reputation bounty. Bounty grace period ends in 22 hours. Zeno Popovici is looking for an answer from a reputable source.
                    </BodyMainTitle>
                    <p>I'm trying to get Valet running on a new MacBook Pro running macOS 12.3. Homebrew, PHP, and Composer are all installed just fine and functioning (to the extent of my knowledge).</p>
                    <p>
                    ...
                    <CodeBox> Name    Status     User File dnsmasq 
                        error  512 root ~/Library/LaunchAgents/homebrew.mxcl.dnsmasq.plist
                    ...
                    <p>The "error" statuses seem suspect, but I've been battling those for years on previous machines where Valet does work.</p>
                    <p>
